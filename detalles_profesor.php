...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-info">
				<div class="panel-heading"><h4 class="text-center">DETALLES PROFESOR</h4></div>
					<div class="panel-body">
						<div class="container-fluid">
							<form class="form-horizontal" name="form_detalles_profesor" id="form_detalles_profesor">
							<div class="form-group">	
									<div class="producto col-md-2 col-md-offset-5" id="imagen">
					...
					<div class="form-group">	
						<div class="col-md-4" id="div_nombres">
							...
							<input class="form-control" type="text" name="nombre" id="nombres" value="" disabled>
							<div class="text-danger" id="error">
			...
			<div class="form-group">
				<div class="col-md-12" id="btn_modificar_profesor">
