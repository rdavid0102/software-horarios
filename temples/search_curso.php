			...
			<div class="panel panel-info">
				...
				<div class="col-md-12"><br>
					<div class="table-responsive">
						<table class="table table-bordered table-hover" id="tabla_cursos">
							<tr class="info">						
								<th>Nombre</th>
								<th>Numero</th>				
							</tr>
						</table>
							<div class="alert alert-warning alert-dismissible" role="alert" id="cursos_vacios">
							Lo sentimos! <strong>No se encontro ningun curso asociado <span class="glyphicon glyphicon-alert"></span></strong> 
							</div>
