	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-info">
				<div class="panel-heading"><h4 class="text-center">DETALLES PROFESOR</h4></div>
					<div class="panel-body">
						<div class="container-fluid">
							<form class="form-horizontal" name="editar" id="editar">
						<?php
							...
							<div class="form-group">	
									<div class="producto col-md-2 col-md-offset-5">
										<?php
											if (($f['imagen'])=='') {
												if ($f['sexo']=="Masculino") {
													?><img class="img img-responsive img-rounded" src="./img/user_m.jpg" title="<?php echo $f['nombres'].' '.$f['apellidos'];?>"><?php
												}
												else{
													?><img class="img img-responsive img-rounded" src="./img/user_f.jpg" title="<?php echo $f['nombres'];?>"><?php
												}
											}
										else{
										 ?>
										<img class="img img-responsive img-rounded" src="./imagenes/<?php echo $f['imagen'];?>" title="<?php echo $f['nombres'];?>" >
										<?php
										}?>
									</div>
							</div>
					...
					<div class="form-group">	
						<div class="col-md-4" id="div_nombres">
							...
							<input class="form-control" type="text" name="nombre" id="nombres" value="<?php echo $f['nombres'];?>" disabled>
							<div class="text-danger" id="error">
			...
			<div class="form-group">
				<div class="col-md-12">
					<a class="btn btn-info btn-block" href="./editar.php? id= <?php echo $_GET['id'];?>" title="Editar Profesor"role="button>">Modificar</a>
				</div>
